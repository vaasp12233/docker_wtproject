...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['mark_attendance'])) {
    ...
    $current_session_id = intval($_POST['session_id']);
    ...
    if (!empty($student_id) && $current_session_id > 0) {
        ...
        if (mysqli_num_rows($student_result) > 0) {
            ...
            mysqli_stmt_execute($check_attendance);  // FIXED: Changed from $check_attention to $check_attendance
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <p class="fw-bold text-primary">
                                        ...
                                        $att_count = mysqli_fetch_assoc($count_result)['count'] ?? 0;
