        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    ...
                    <a href="mark_attendance.php" class="btn btn-outline-primary">
                    ...
                    <div class="col-lg-8 mb-4">
                        <div class="card shadow-lg border-0 h-100">
                            ...
                            <div class="card-body text-center">
                                ...
                                <!-- Manual Input Form - REMOVED as requested -->
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="list-group-item d-flex align-items-center">
                                        ...
                                        <div>Use "Manual Attendance" button for traditional entry</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-lg border-0">
                            ...
                            <div class="card-body" style="max-height: 320px; overflow-y: auto;">
                                ...
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted small">Scan QR codes to mark attendance</p>
                                </div>
                                <?php endif; ?>
