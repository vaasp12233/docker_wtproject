                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center">
                        <svg width="100%" height="400" viewBox="0 0 800 400" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 10px; max-height: 400px;">
                            ...
                            <!-- Icons -->
                            <!-- People icon -->
                            <circle cx="80" cy="320" r="15" fill="#e3f2fd"/>
                            <text x="80" y="325" text-anchor="middle" font-family="Arial" font-size="14" fill="#1565c0">👥</text>
                            
                            <!-- Calendar icon -->
                            <circle cx="150" cy="320" r="15" fill="#e8f5e8"/>
                            <text x="150" y="325" text-anchor="middle" font-family="Arial" font-size="14" fill="#2e7d32">📅</text>
                            
                            <!-- Chart icon -->
                            <circle cx="220" cy="320" r="15" fill="#fff3e0"/>
                            <text x="220" y="325" text-anchor="middle" font-family="Arial" font-size="14" fill="#ef6c00">📊</text>
                        </svg>
                    </div>
                </div>
            </div>
