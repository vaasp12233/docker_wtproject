...
// This prevents "headers already sent" errors on Render
if (!ob_get_level()) {
    ob_start();
}
...
// ==================== Clean buffer before including header ====================
if (ob_get_length() > 0 && !headers_sent()) {
    ob_end_clean();
    ob_start(); // Start new buffer for output
}
                ...
                <div class="col-md-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-primary text-white">
                            <h4 class="mb-0"><i class="fas fa-chart-bar me-2"></i> System Statistics</h4>
                        </div>
                        <div class="card-body">
                            <div class="row text-center">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="stat-card p-3 border rounded">
                                        ...
                                        <p class="text-muted mb-0">QR Scans/Day</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="stat-card p-3 border rounded">
