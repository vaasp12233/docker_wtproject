...
// Initialize filter variables (same as 360_students_attendance.php)
...
// Get all students with their basic info (same logic as 360_students_attendance.php)
...
// Get total sessions for each subject
$subject_sessions = [];
...
// Handle export requests (this is the main functionality)
if (isset($_GET['export'])) {
    ...
    elseif ($export_type == 'excel') {
        ...
        if (!empty($subject_filter)) {
            $subject_name = $subject_sessions[$subject_filter]['subject_name'] ?? 'Selected Subject';
            echo 'Subject: ' . $subject_name . ' | ';
        }
        if (!empty($section_filter)) {
            echo 'Section: ' . $section_filter . ' | ';
        }
        if (!empty($search_query)) {
        ...
        <body>
            <div class="header">
                ...
                <div class="summary">
                    ...
                    <strong>Date Range:</strong> ' . $date_from . ' to ' . $date_to . '</p>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <?php 
                    if (!empty($subject_filter) && isset($subject_sessions[$subject_filter])) {
            ...
            <div class="mt-3">
                <a href="360_students_attendance.php?<?php echo http_build_query($_GET); ?>" 
